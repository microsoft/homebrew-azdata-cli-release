...
class AzdataCli < Formula
  ...
  url "https://github.com/microsoft/homebrew-azdata-cli-release/releases/download/20.3.3/azdata-cli.tar.gz"
  version "20.3.3"
  sha256 "dd2586ae534241bdd538f69b3ed3479e7b275320eb6ecfe383fc4bcc1559837e"

  bottle do
    root_url "https://github.com/microsoft/homebrew-azdata-cli-release/releases/download/20.3.3"
    sha256 cellar: :any, catalina: "a9de785eb27227f494a1b1509b6ac6defe32fdcd30fd6920de7b6f985c8d2be2"
    sha256 cellar: :any, mojave: "c7d93255d0775b76489a225ee7a43bb4656eb802e1d0a02dad2e23dff1c98789"
  end
  ...
  resource "qtconsole" do
    url "https://files.pythonhosted.org/packages/24/11/b9603e8ae56107789d7ef21ea937675623986bdf3e9a8b195f146782343d/qtconsole-5.0.3.tar.gz"
